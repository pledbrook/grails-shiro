...
public class ShiroBasicPermission implements Permission {
     ...
     */
    public ShiroBasicPermission(String target, String actions) {
        this.target = target;
     ...
     */
    public ShiroBasicPermission(String target, Collection actions) {
        this.target = target;
    ...
    public boolean implies(Permission p) {
        boolean implies = (p instanceof ShiroBasicPermission);

        if (implies) {
            // Check the target strings are the same.
            ShiroBasicPermission perm = (ShiroBasicPermission) p;
            if (this.target == null) {
    ...
    public boolean equals(Object obj) {
        ...
        ShiroBasicPermission p = (ShiroBasicPermission) obj;
